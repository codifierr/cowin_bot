...
Run the binary with below command arg. create a telegram bot using botfather and provide chat_id and telegram bot token and optional err_chat_id can be provided where bot will in case on case of any error while trying to get data from cowin apis
```
